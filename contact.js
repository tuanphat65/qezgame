...
var iconHook5 = document.querySelector ('.icon-main');
var iconHook4 = document.querySelector ('.icon-hover');
iconHook5.addEventListener('mouseover', function (){
    offerHook5.style.display = 'none';
    offerHook4.style.display = 'block';
})
iconHook4.addEventListener('mouseout',function (){
